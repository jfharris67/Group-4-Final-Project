...
-- Best hours of day for on-time arrivals
...
-- Worst hours of day for on-time arrivals
-- Worst hours of day for on-time arrivals
WITH formatted_flights AS (
    SELECT
        ARR_DEL15,
...
-- Best time blocks for on-time departures
(
SELECT
DEP_TIME_BLK,
...
-- Worst time blocks for on-time departures
(
SELECT
DEP_TIME_BLK,
COUNT(DEP_DEL15) AS total_flights,
